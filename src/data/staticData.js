...
// NOTE: IDs must match PortfolioTemplatesPage.jsx PORTFOLIO_TEMPLATES
export const PORTFOLIO_TEMPLATES = [
  {
    id: 'midnight-dev',
    name: 'Midnight Dev',
    description: 'Dark developer portfolio with a terminal-inspired hero and neon accent highlights.',
    tags: ['Dark', 'Developer', 'Modern'],
    accent: '#7C3AED',
    // flat fields (used by PortfolioPreviewPage / PortfolioCustomizerPage)
    primaryColor: '#7C3AED',
    accentColor: '#06B6D4',
    bgColor: '#0F172A',
    textColor: '#F8FAFC',
    layout: 'dark',
    style: 'terminal',
    // defaultStyle object (used by PortfolioTemplatesPage to seed portfolioStyle)
    defaultStyle: {
      layout: 'dark', primaryColor: '#7C3AED', accentColor: '#06B6D4',
  ...
  },
  {
    ...
    style: 'minimal',
    defaultStyle: {
      layout: 'light', primaryColor: '#6D28D9', accentColor: '#0EA5E9',
  ...
  },
  {
    ...
    style: 'gradient',
    defaultStyle: {
      layout: 'gradient', primaryColor: '#EC4899', accentColor: '#F59E0B',
      bgColor: '#0D0221', textColor: '#F8FAFC',
    },
  },
  {
    id: 'glass-dark',
    ...
    style: 'glass',
    defaultStyle: {
      layout: 'dark', primaryColor: '#0EA5E9', accentColor: '#8B5CF6',
      bgColor: '#060B18', textColor: '#E0F2FE',
    },
  },
  {
    id: 'minimal-light',
    ...
    style: 'minimal',
    defaultStyle: {
      layout: 'light', primaryColor: '#18181B', accentColor: '#DC2626',
      bgColor: '#FAFAFA', textColor: '#18181B',
    },
  },
  {
    id: 'neon-cyber',
    name: 'Neon Cyber',
    description: 'Electric neon accents on a deep dark background. Ideal for standout tech portfolios.',
    tags: ['Dark', 'Neon', 'Tech'],
    accent: '#22D3EE',
    primaryColor: '#22D3EE',
    accentColor: '#A855F7',
    ...
    style: 'neon',
    defaultStyle: {
      layout: 'dark', primaryColor: '#22D3EE', accentColor: '#A855F7',
      bgColor: '#020817', textColor: '#E2E8F0',
    },
  },
];
